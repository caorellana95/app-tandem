...
export default function Header() {
    ...
    return(
        <div>
            <nav className='bg-blue-700 flex flex-row sm:flex-row justify-between text-white'>

                {/* ESCRITORIO */}
                <div className='sm:flex hidden w-11/12 flex mt-4 text-center justify-center ml-14 text-white text-xl font-medium leading-normal not-italic'>
