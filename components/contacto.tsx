...
export default function Home() {
  ...
  return (
    <main className="w-full bg-[url('/banner_contacto.jpg')] md:bg-[length:100%_382px] lg:bg-[length:100%_382px] xl:bg-[length:100%_382px] sm:bg-auto bg-no-repeat md:bg-origin-border lg:bg-origin-border xl:bg-origin-border bg-top-center">
      ...
      <div className='w-full'>
        <Image
          ...
          src={'/tandem_header_contacto.png'}
          alt='Logo'
          width={ 330 }
          height={ 74 }/>
      </div>
